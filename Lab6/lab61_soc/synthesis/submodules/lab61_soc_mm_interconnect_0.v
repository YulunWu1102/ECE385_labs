...
module lab61_soc_mm_interconnect_0 (
	...
	wire  [105:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> key1_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // key1_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> key1_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> key0_s1_agent:cp_data
	...
	wire  [105:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> switch_s1_agent:cp_data
	...
	wire  [105:0] key1_s1_agent_rp_data;                                                              // key1_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [105:0] key0_s1_agent_rp_data;                                                              // key0_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [105:0] switch_s1_agent_rp_data;                                                            // switch_s1_agent:rp_data -> router_010:sink_data
	...
	lab61_soc_mm_interconnect_0_router_001 router_001 (
	...
	lab61_soc_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
